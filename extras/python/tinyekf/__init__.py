...
class EKF(object):
    '''
    A abstract class for the Extended Kalman Filter, based on the tutorial in
    ...
    def f(self, x, u):
        '''
        Your implementing class should define this method for the state-
        transition function f(x). Your state-transition fucntion should return
        a NumPy array of n elements representing the new state, and a nXn NumPy
        array of elements representing the the Jacobian of the function
    ...
    def h(self, x):
        '''
        Your implementing class should define this method for the observation
